...
export default function LiabilitiesPage() {
  ...
  // 타입별 그룹화
  const usedTypes: LiabilityType[] = [
    ...new Set(liabilities.map((l) => l.liability_type)),
  ];
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div
          className={`rounded-2xl card-shadow p-5 ${netWorth >= 0 ? "bg-gradient-to-br from-emerald-50 to-white" : "bg-gradient-to-br from-rose-50 to-white"}`}
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p
                className={`text-xl font-bold ${netWorth >= 0 ? "text-emerald-600" : "text-rose-600"}`}
              >
                {netWorth < 0 && "-"}
        ...
        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              {liabilities.length}건 · 총 {formatCurrency(totalLiability)}
            </p>
          </div>
          <Button
            onClick={openAdd}
            className="rounded-xl gradient-primary text-white border-0 shadow-sm text-sm"
          >
                ...
                <div key={type}>
                  ...
                  <div className="space-y-2">
                    {list.map((l) => (
                      <div
                        key={l.id}
                        className="bg-gradient-to-br from-rose-50/50 to-white border border-rose-100/50 rounded-xl p-4 flex items-start justify-between gap-3 hover:shadow-md transition-shadow"
                      >
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  {l.name} ({formatCurrency(Number(l.balance))}
                                  )을 삭제합니다.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setForm((f) => ({ ...f, liability_type: v as LiabilityType }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setForm((f) => ({
                    ...f,
                    balance: String(parseAmountInput(e.target.value)),
                  }))
                }
              />
            </div>
